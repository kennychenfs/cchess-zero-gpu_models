...
pushd cchess-zero
while true; do
  echo python main.py --mode train --train_playout 1600 --batch_size ${BATCH_SIZE} --end_of_batch ${END_OF_BATCH}
  python main.py --mode train --train_playout 1600 --batch_size ${BATCH_SIZE} --end_of_batch ${END_OF_BATCH}
  pushd gpu_models
